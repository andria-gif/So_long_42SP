...
MAPA_SRCS	=	so_long.c maps_read.c maps_valid.c utils_game.c render_map.c maps_flood_free_exit_ber.c maps_dimensions.c game_texture.c  game_position_player.c game_moviment_player.c maps_check_line.c
MAPA_DIR	=	src/
OBJ_DIR		=	build/
